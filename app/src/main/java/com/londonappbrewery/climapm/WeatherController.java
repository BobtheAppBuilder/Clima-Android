...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "255ea65bd81b898771222c3999e464fe";
     ...
     private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                        ...
                        Log.d("Clima", "Status Code: " + Integer.toString(statusCode));
                        Log.d("Clima", "Error Response: " + errorResponse.toString());

                        Toast.makeText(WeatherController.this, "JSON GET failed", Toast.LENGTH_SHORT);
                    }
                });
     }
